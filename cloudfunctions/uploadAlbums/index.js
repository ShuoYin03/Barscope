...
exports.main = async event => {
  ...
  const updateOps = toUpdate.map(a => {
    ...
    if (Array.isArray(a.collaboratorArtists) && a.collaboratorArtists.length) fields.collaboratorArtists = a.collaboratorArtists
    if (Array.isArray(a.collaboratorArtistIds) && a.collaboratorArtistIds.length) fields.collaboratorArtistIds = a.collaboratorArtistIds.map(String)
    if (Array.isArray(a.collaboratorArtistNames) && a.collaboratorArtistNames.length) fields.collaboratorArtistNames = a.collaboratorArtistNames
