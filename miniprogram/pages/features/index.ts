...
const FEATURES = [
  ...
  { id:'rapper-interview', category:'人物访谈', title:'Rapper 心里话', subtitle:'广告位等待投稿中…', status:'等待你的采访与人物故事', accent:'05', cta:'投稿' },
]
...
Page({
  ...
  onFeatureTap(e:WechatMiniprogram.TouchEvent){ const id=String((e.currentTarget.dataset as any).id||''); if(!id)return; if(id==='2026-top-reviewers'){wx.navigateTo({url:'/pages/annual-reviewers/index'});return} wx.navigateTo({url:`/pages/feature-detail/index?id=${id}`}) }
})
