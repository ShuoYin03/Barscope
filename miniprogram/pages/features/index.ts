...
const FEATURES = [
  ...
  { id:'rapper-interview', category:'人物访谈', title:'在作品之外，听见 Rapper 如何成为自己', subtitle:'从创作方法、成长经历到行业选择，保留音乐之外更真实的表达。', author:'BEATWEEN CONVERSATIONS', date:'2026.07', readTime:'10 MIN', accent:'03' },
]
